...
Скачайте новый Commutator.pkg [по той же ссылке](https://github.com/and-sheera/commutator/releases/latest/download/Commutator.pkg) и установите поверх, как в первый раз. Профили, правила и настройки сохранятся. Текущую версию видно в «Диагностике».

## Удаление

**«Общие» → «Удалить Коммутатор…»** и пароль администратора. Приложение выключит VPN, вернёт сеть в состояние до установки и удалит себя, системную службу, профили и настройки.
